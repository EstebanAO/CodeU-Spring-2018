...
public class ConversationStoreTest {
  ...
  private final Conversation CONVERSATION_ONE =
      new Conversation(
          UUID.randomUUID(), UUID.randomUUID(), "conversation_one", Instant.ofEpochMilli(1000), new HashSet<>(Arrays.asList(UUID.randomUUID())));
  ...
  public void testAddConversation() {
    Conversation inputConversation =
        new Conversation(UUID.randomUUID(), UUID.randomUUID(), "test_conversation", Instant.now(), new HashSet<>(Arrays.asList(UUID.randomUUID())));
